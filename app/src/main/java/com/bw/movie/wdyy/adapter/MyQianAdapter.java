...
import com.bw.movie.wdyy.bean.CheckBean;
 ...
 */
public class MyQianAdapter extends BaseAdapter {
    private Context mContext;
    private List<CheckBean> checkBeanList;

    public MyQianAdapter(Context context) {
        mContext = context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.qiandao2, null);
            hoder = new MyHoder();
